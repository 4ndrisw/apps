...
if (!$CI->db->table_exists(db_prefix() . 'apps_widget_categories')) {
  $CI->db->query("
    CREATE TABLE " . db_prefix() . "apps_widget_categories (
  ...
  $CI->db->query("
    ALTER TABLE " . db_prefix() . "apps_widget_categories
    ADD PRIMARY KEY (id);
  ");
  ...
  $CI->db->query("
    INSERT INTO " . db_prefix() . "apps_widget_categories (`id`, `name`, `note`) VALUES
...
if (!$CI->db->table_exists(db_prefix() . 'apps_list')) {
  $CI->db->query("
    CREATE TABLE " . db_prefix() . "apps_list (
    id                    BIGINT(20) NOT NULL,
    name                  VARCHAR(191) DEFAULT NULL,
  ...
  $CI->db->query("
    ALTER TABLE " . db_prefix() . "apps_list
    ADD PRIMARY KEY (id);
  ");
...
if (!$CI->db->table_exists(db_prefix() . 'apps_users')) {
  $CI->db->query("
    CREATE TABLE " . db_prefix() . "apps_users (
    id                    BIGINT(20) NOT NULL,
  ...
  $CI->db->query("
    ALTER TABLE " . db_prefix() . "apps_users
    ADD PRIMARY KEY (id);
  ");
  ...
  // Default dashboard
  $CI->db->query("
    INSERT INTO " . db_prefix() . "apps_list (`id`, `name`, `dashboard_widgets`, `note`, `updated_at`, `created_at`) VALUES
...
if (!$CI->db->table_exists(db_prefix() . 'apps_widgets')) {
  $CI->db->query("
    CREATE TABLE " . db_prefix() . "apps_widgets (
    id                    BIGINT(20) NOT NULL,
    name                  VARCHAR(191) DEFAULT NULL,
  ...
  $CI->db->query("
    ALTER TABLE " . db_prefix() . "apps_widgets
    ADD PRIMARY KEY (id);
  ");
  ...
  // Default widgets
  $CI->db->query("
    INSERT INTO " . db_prefix() . "apps_widgets (`name`, `category`, `widget_name`, `default_container`, `note`) VALUES
