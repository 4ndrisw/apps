(function($) { 
          ...
          var calendar_settings = {
            ...
            eventSources: [
              function (info, successCallback, failureCallback) {
                ...
                return $.getJSON(
                  admin_url + "apps/widgets/api_get_calendar_data",
                  $.extend({}, params, {
                    start: info.startStr,
                    end: info.endStr,
                  })
            ...
            dateClick: function (info) {
              ...
              $("#apps_new_event_modal_" + widgetId).modal("show");
              return false;
            },
          };
    ...
    $(".widget-tickets-chart").each(function () {
      ...
      if (tickets_chart_departments.length > 0) {
        var tickets_dep_chart = new Chart(tickets_chart_departments, {
          type: "doughnut",
          data: window[
            "apps_widget_tickets_chart_tickets_awaiting_reply_by_department_" +
              widgetId +
      ...
      if (tickets_chart_status.length > 0) {
        new Chart(tickets_chart_status, {
          type: "doughnut",
          data: window[
            "apps_widget_tickets_chart_tickets_reply_by_status_" +
              widgetId +
    ...
    $(".widget-todos").each(function () {
      ...
      $(".widget-" + widgetId + " .read-more").readmore({
        ...
        moreLink:
          '<a href="#">' +
          window[
            "apps_widget_todos_" + widgetId + "lang_read_more"
          ] +
          "</a>",
        lessLink:
          '<a href="#">' +
          window[
            "apps_widget_todos_" + widgetId + "lang_show_less"
          ] +
          "</a>",
      });
    });
  ...
  (function () {
    $(".widget-weekly-payments-chart").each(function () {
      ...
      init_weekly_payment_statistics(
        window[
          "apps_widget_weekly_payments_chart_" +
            widgetId +
  ...
  (function () {
    $(".widget-monthly-income").each(function () {
      ...
      new Chart($("#apps_widget_" + widgetId + "_chart_income"), {
        type: "bar",
        data: window[
          "apps_widget_monthly_income_" + widgetId + "_data"
        ],
        options: {
          responsive: true,
          maintainAspectRatio: false,
      ...
      if (total_income_selector.length > 0) {
        total_income_selector.text(format_money(total_income_selector.text()));
      }
    });
  })();
    ...
    $(".widget-top-10-selling-products").each(function () {
      ...
      if (selector_priceables.length > 0) {
        selector_priceables.each(function () {
          $(this).text(format_money($(this).text()));
        });
      }
  ...
  (function () {
    $(".widget-total-staff-of-roles").each(function () {
      ...
      if (chart.length > 0) {
        new Chart(chart, {
          type: "doughnut",
          data: window["apps_widget_" + widgetId + "_chart_data"],
          options: {
            maintainAspectRatio: false,
            onClick: function (evt) {
              onChartClickRedirect(evt, this);
  ...
  (function () {
    $(".widget-staff-increment-by-years").each(function () {
      ...
      new Chart($("#apps_widget_" + widgetId + "_chart"), {
        type: "bar",
        data: window["apps_widget_" + widgetId + "_data"],
        options: {
          responsive: true,
          maintainAspectRatio: false,
          legend: {
  ...
  (function () {
    $(".widget-leads-and-converted-leads-by-sources").each(function () {
      ...
      new Chart($("#apps_widget_" + widgetId + "_chart_data"), {
        type: "bar",
        data: window["apps_widget_" + widgetId + "_chart_data"],
        options: {
          responsive: true,
