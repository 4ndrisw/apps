    ...
    <div class="panel_s">
      <div class="panel-body">
        ...
        <div class="perfexdashboard-button-wrap">
          <?php if(has_permission('apps','','widget_category_create')){ ?>
...
<!-- form create -->
<form action="<?php echo base_url('admin/apps/categories/store_category'); ?>" method="post" class="form-horizontal">
...
<!-- form edit -->
<form action="<?php echo base_url('admin/apps/categories/update_category'); ?>" method="post" class="form-horizontal">
...
<!-- form delete -->
<form id="formDelete" action="<?php echo base_url('admin/apps/categories/destroy_category'); ?>" method="post" class="d-none">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
  <input type="hidden" name="id" value="" />
</form>
<script>
