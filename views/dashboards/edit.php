...
$this->app_scripts->add('apps_widget_scripts', APPS_ASSETS_PATH . '/js/widgets/widget.js');
$this->app_css->add('apps_widget_styles', APPS_ASSETS_PATH . '/css/widget.css');
$categories = apps_get_categories();
...
?>
  ...
  <div id="wrapper">
    <div class="content">
      <div class="row">
        <div class="col-md-12">
          <form method="get" action="<?php echo admin_url('apps/dashboards/edit_dashboard'); ?>">
      ...
      <?php } else { ?>
        <div class="row mtop30">
          <div class="col-md-3" data-container="top-left-first-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'top-left-first-4'); ?>
          </div>
          <div class="col-md-3" data-container="top-left-last-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'top-left-last-4'); ?>
          </div>
          <div class="col-md-3" data-container="top-right-first-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'top-right-first-4'); ?>
          </div>
          <div class="col-md-3" data-container="top-right-last-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'top-right-last-4'); ?>
          </div>
        </div>

        <div class="row">
          <div class="col-md-12" data-container="top-12">
            <?php apps_render_widgets_from_dashboard($dashboard, 'top-12'); ?>
          </div>
        </div>

        <div class="row">
          <div class="col-md-6" data-container="middle-left-6">
            <?php apps_render_widgets_from_dashboard($dashboard, 'middle-left-6'); ?>
          </div>
          <div class="col-md-6" data-container="middle-right-6">
            <?php apps_render_widgets_from_dashboard($dashboard, 'middle-right-6'); ?>
          </div>
        </div>

        <div class="row">
          <div class="col-md-8" data-container="left-8">
            <?php apps_render_widgets_from_dashboard($dashboard, 'left-8'); ?>
          </div>
          <div class="col-md-4" data-container="right-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'right-4'); ?>
          </div>
        </div>

        <div class="row">
          <div class="col-md-4" data-container="bottom-left-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'bottom-left-4'); ?>
          </div>
          <div class="col-md-4" data-container="bottom-middle-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'bottom-middle-4'); ?>
          </div>
          <div class="col-md-4" data-container="bottom-right-4">
            <?php apps_render_widgets_from_dashboard($dashboard, 'bottom-right-4'); ?>
          </div>
        </div>
      <?php } ?>
  ...
  <form action="<?= admin_url('apps/dashboards/update_dashboard')  ?>" method="post" class="form-horizontal">
  ...
  <!-- modal add widget -->
  <form id="formAddWidget" action="<?php echo base_url('admin/apps/dashboards/add_widget'); ?>" method="post" class="form-horizontal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="perfexdashboard-actions-wrap">
              ...
              &nbsp;
              <a href="<?php echo admin_url('apps/widgets'); ?>" class="btn btn-primary"><?= _l('view_all') ?></a>
            </div>
  ...
  <!-- modal staff -->
  <form action="<?= admin_url('apps/dashboards/update_staff')  ?>" method="post" class="form-horizontal">
    <div id="modalUpdateStaff" class="modal">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><?= _l('apps_staff_modal_title') ?></h5>
          </div>
          <div class="modal-body">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
