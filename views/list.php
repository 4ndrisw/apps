...
<div id="wrapper" class="perfex-dashboard-widget-list">
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <form method="get" action="<?php echo admin_url('apps/widgets'); ?>">
          <div class="perfexdashboard-actions-wrap perfexdashboard-actions-wrap-between">
            <div class="perfexdashboard-actions-section-left">
              <?php if (has_permission('apps', '', 'widget_create')) { ?>
    ...
    <div class="row">
      <?php if (count($widgets) > 0) { ?>
        <div class="col-md-12 mtop30">
          <div class="row">
            <?php apps_render_widgets($widgets); ?>
          </div>
        </div>
      <?php } else { ?>
        <div class="col-md-12 mtop30">
...
<!-- create widget -->
<form action="<?= admin_url('apps/widgets/store_widget')  ?>" method="post" class="form-horizontal">
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <div class="input-group-addon">
                  <span><a href="<?php echo admin_url('apps/categories'); ?>" tabindex="-1"><i class="fa fa-plus"></i></a></span>
                </div>
              </div>
            </div>
          </div>
...
<!-- edit widget -->
<form action="<?= admin_url('apps/widgets/update_widget')  ?>" method="post" class="form-horizontal">
...
<!-- form delete widget -->
<form id="formDeleteWidget" action="<?php echo base_url('admin/apps/widgets/destroy_widget'); ?>" method="post" class="d-none">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
  <input type="hidden" name="id" value="" />
</form>
...
<script>
  ...
  <?php } ?>
  <?php if (has_permission('apps', '', 'widget_delete')) { ?>
